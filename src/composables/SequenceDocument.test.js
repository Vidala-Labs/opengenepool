...
describe('SequenceDocument', () => {
  describe('constructor', () => {
    ...
    it('creates document with initial values', () => {
      const doc = new SequenceDocument({
        sequence: 'ATCGATCG',
        annotations: [{ id: '1', caption: 'test', type: 'gene', span: ezSpan(0, 4) }],
        circular: true
      })
    ...
    it('normalizes annotations without id', () => {
      const doc = new SequenceDocument({
        sequence: 'ATCG',
        annotations: [{ caption: 'test', type: 'CDS', span: ezSpan(0, 4) }]
      })
  ...
  describe('annotation methods', () => {
    ...
    beforeEach(() => {
      doc = new SequenceDocument({
        ...
        annotations: [
          { id: 'ann1', caption: 'Gene1', type: 'gene', span: ezSpan(0, 4) },
          { id: 'ann2', caption: 'Gene2', type: 'CDS', span: ezSpan(6, 10) }
        ]
      })
    })
  ...
  describe('serialization', () => {
    ...
    it('creates from JSON', () => {
      const data = {
        sequence: 'ATCGATCG',
        annotations: [{ id: '1', caption: 'Test', type: 'CDS', span: ezSpan(0, 4) }],
        circular: true
      }
  ...
  describe('backend integration', () => {
    ...
    it('calls backend.annotationUpdate on updateAnnotation', () => {
      ...
      const doc = new SequenceDocument({
        sequence: 'ATCG',
        annotations: [{ id: 'ann1', caption: 'Test', type: 'gene', span: ezSpan(0, 4) }],
        backend
      })
  ...
  describe('annotation adjustment on insert', () => {
    it('shifts annotations after insertion point', () => {
      const doc = new SequenceDocument({
        sequence: 'ATCGATCG',
        annotations: [{ id: 'ann1', caption: 'Test', type: 'gene', span: ezSpan(4, 8) }]
      })
      doc.insert(2, 'GGG')
    ...
    it('expands annotations containing insertion point', () => {
      const doc = new SequenceDocument({
        sequence: 'ATCGATCG',
        annotations: [{ id: 'ann1', caption: 'Test', type: 'gene', span: ezSpan(2, 6) }]
      })
      doc.insert(4, 'GGG')
    ...
    it('does not change annotations before insertion point', () => {
      const doc = new SequenceDocument({
        sequence: 'ATCGATCG',
        annotations: [{ id: 'ann1', caption: 'Test', type: 'gene', span: ezSpan(0, 2) }]
      })
      doc.insert(4, 'GGG')
  ...
  describe('annotation adjustment on delete', () => {
    it('shifts annotations after deletion', () => {
      const doc = new SequenceDocument({
        sequence: 'ATCGATCG',
        annotations: [{ id: 'ann1', caption: 'Test', type: 'gene', span: ezSpan(6, 8) }]
      })
    ...
    it('shrinks annotations containing deletion', () => {
      const doc = new SequenceDocument({
        sequence: 'ATCGATCGATCG',
        annotations: [{ id: 'ann1', caption: 'Test', type: 'gene', span: ezSpan(2, 10) }]
      })
    ...
    it('collapses annotations contained by deletion', () => {
      const doc = new SequenceDocument({
        sequence: 'ATCGATCGATCG',
        annotations: [{ id: 'ann1', caption: 'Test', type: 'gene', span: ezSpan(4, 6) }]
      })
